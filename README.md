...
1. Make extension work in Backup mode - Not an option if you are using the app in multiple devices
2. Check the setting "Alert if cloud backup is smaller during import". This will prompt for a confirmation. In the above scenario, you should click cancel and it will skip the cloud import as the local data is bigger.
